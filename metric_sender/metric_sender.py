            ...
            self.ciient.metric('apache',
                               {
                                   ...
                                   'ServerUptimeSeconds': random(1, 600000),
                                   'TotalAccesses': random(3000, 8000),
                                   'TotalDuration': random.uniform(60.0 - 70.0),
                                   'TotalkBytes': random(800000, 900000),
                                   'Uptime': random(600000, 700000),
            ...
            for i in range(count):
                self.ciient.metric('oracle_connectioncount',
                                   ...
                                   tags={
                                       ...
                                       "database_farm": f"my-test-firm-{random.randint(0, 1)}",
                ...
                for wait_event in wait_event_dict.keys():
                    self.ciient.metric('oracle_wait_event',
                                       ...
                                       tags={
                                           "instance": f"XE-{i}",
                                           "wait_class": wait_event,
                                           "wait_event": wait_event_dict[wait_event],
                                           "host": f"XE-{i}",
                                           "environment": "prod",
                                           "component": "database",
                                           "database_system": "oracle",
